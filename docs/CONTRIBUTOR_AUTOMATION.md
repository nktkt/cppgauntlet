...
Issue lifecycle status remains a maintainer decision. Use [ISSUE_LIFECYCLE.md](ISSUE_LIFECYCLE.md) before applying `status: needs-info`, `status: blocked`, or `status: stale`.
